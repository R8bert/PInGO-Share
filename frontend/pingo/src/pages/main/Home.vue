<template>
  <div class="min-h-screen transition-colors duration-300" 
          ...
          <div class="relative">
            ...
            <div class="relative backdrop-blur-xl border rounded-3xl p-8 sm:p-12"
              ...
              <div v-if="uploadComplete" class="text-center">
                <div class="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-green-400 to-emerald-600 rounded-full flex items-center justify-center">
                ...
                <p class="text-gray-600 dark:text-gray-300 mb-8">
                  Your files have been successfully uploaded and are ready to share.
                </p>
              ...
              <div class="mb-6" v-if="validityOptions.length > 0">
                ...
                <div class="grid gap-4">
                  <div v-for="(file, index) in selectedFiles" :key="index" 
                    ...
                    <!-- Preview Section -->
                    <div v-if="previewingFiles.has(index)" class="px-4 pb-4">
                      <div class="rounded-lg border-t pt-4"
                           :style="{ borderColor: isDark ? 'rgba(255,255,255,0.1)' : 'rgba(0,0,0,0.1)' }">
                        
                        <!-- Image preview -->
                        <div v-if="['jpg', 'jpeg', 'png', 'gif', 'webp'].includes(getFileExtension(file))">
                          <img 
                        ...
                        <!-- Video preview -->
                        <div v-else-if="getFileExtension(file) === 'mp4'">
                          <video 
                            :src="previewUrls.get(index)"
                            controls 
                            class="w-full max-w-md mx-auto rounded-lg shadow-lg">
                        ...
                        <!-- Audio preview -->
                        <div v-else-if="['mp3', 'wav', 'flac'].includes(getFileExtension(file))">
                          <audio 
                            :src="previewUrls.get(index)"
                            controls 
                        ...
                        <!-- PDF preview -->
                        <div v-else-if="getFileExtension(file) === 'pdf'">
                          <div class="text-center p-4">
                            <svg class="w-16 h-16 mx-auto mb-2 text-red-500" fill="currentColor" viewBox="0 0 24 24">
                              <path d="M14,2H6A2,2 0 0,0 4,4V20A2,2 0 0,0 6,22H18A2,2 0 0,0 20,20V8L14,2M18,20H6V4H13V9H18V20Z" />
                            </svg>
                            <p class="text-sm" :style="{ color: isDark ? '#a1a1aa' : '#71717a' }">
                ...
                <div v-if="progress > 0 && progress < 100" class="mt-6">
                  <div class="flex justify-between text-sm mb-2" :style="{ color: isDark ? '#a1a1aa' : '#71717a' }">
                    <span>Uploading...</span>
                    <span>{{ progress }}%</span>
                  </div>
    ...
    <div v-if="message.text" 
      ...
      <div class="flex items-center space-x-3">
        <div v-if="message.type === 'success'" class="w-8 h-8 bg-green-500 rounded-full flex items-center justify-center flex-shrink-0">
        ...
        <div class="flex-1">
          ...
          <p v-if="message.type === 'success' && progress === 100" class="text-sm opacity-75 mt-1">
