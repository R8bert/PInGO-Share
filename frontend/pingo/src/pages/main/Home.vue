                        ...
                        <div class="space-y-6 animate-fade-in-delay">
                            ...
                            >
                                ...
                                <RotatingText
                                    ...
                                    mainClassName=" inline-flex w-fit whitespace-pre-wrap relative animate-fade-in-delay px-1 sm:px-2 md:px-3 bg-gradient-to-b from-blue-500 to-purple-500 text-black overflow-hidden py-0.5 sm:py-1 md:py-2 justify-center rounded-lg"
                                    :initial="{ y: '100%' }"
                                    :animate="{ y: 0 }"
                                    :exit="{ y: '-120%' }"
