              ...
              <div class="relative">
                ...
                <div class="relative backdrop-blur-xl border rounded-3xl p-8"
                  ...
                  <div class="flex items-center space-x-6">
                    <!-- Avatar -->
                    <div class="relative">
                      <div class="w-20 h-20 rounded-2xl overflow-hidden border-2"
                      ...
                      <div class="absolute -bottom-1 -right-1 w-6 h-6 bg-green-500 rounded-full border-4"
                           :style="{ borderColor: isDark ? '#000000' : '#ffffff' }"></div>
                    </div>
...
const fetchShareData = async () => {
  try {
    const response = await axios.get(`http://localhost:8080/api/share/${route.params.id}`)
    if (response.data) {
